...
//             console.log('vector', vector.name, vector.payload);

//             const encrypted = encrypt(key, vector.payload !== null ? vector.payload : '{}', {
//                 assertion: nonce,
//                 addIat: false,
//             });

//             console.log(encrypted, vector.token, encrypted === vector.token);
